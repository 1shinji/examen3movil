...
const routes: Routes = [
  ...
  {
    path: 'pruebas-sqlite',
    loadChildren: () => import('./pages/pruebas-sqlite/pruebas-sqlite.module').then( m => m.PruebasSqlitePageModule)
  },
  {
    path: 'biografias',
    loadChildren: () => import('./biografias/biografias.module').then( m => m.BiografiasPageModule)
  },
  {
    path: 'biografia-detallada',
    loadChildren: () => import('./biografia-detallada/biografia-detallada.module').then( m => m.BiografiaDetalladaPageModule)
  }
];

...
import { AngularFireMessagingModule } from '@angular/fire/compat/messaging'; // Importar AngularFireMessagingModule
...
import { FcmService } from './services/fcm.service'; // Importar el servicio para Firebase Messaging
...
@NgModule({
  ...
  imports: [
    ...
    AngularFireMessagingModule, // Agregar Firebase Messaging
  ...
  providers: [
    ...
    EntradasService,
    EventosService,
    FcmService, // Proveer el servicio de notificaciones push
    SQLite,
